...
<!-- JQVMap -->
<link rel="stylesheet" href="/adminlte/plugins/jqvmap/jqvmap.min.css" href="plugins/jqvmap/jqvmap.min.css">
<!-- Daterange picker -->
<link rel="stylesheet" href="/adminlte/plugins/daterangepicker/daterangepicker.css" href="plugins/daterangepicker/daterangepicker.css">
<!-- summernote -->
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-3 col-6">
							<!-- small box -->
							<div class="small-box bg-info" data-aos="fade-right">
								<div class="inner">
									<h3>150</h3>
						...
						<div class="col-lg-3 col-6">
							<!-- small box -->
							<div class="small-box bg-success" data-aos="fade-right">
								<div class="inner">
									<h3>
						...
						<div class="col-lg-3 col-6">
							<!-- small box -->
							<div class="small-box bg-warning" data-aos="fade-left">
								<div class="inner">
									<h3>44</h3>
					...
					<div class="row">
								...
								<div class="card-body">
									...
									<div class="direct-chat-contacts">
										<ul class="contacts-list">
											<li><a href="#"> <img class="contacts-list-img" src="/adminlte/dist/img/user1-128x128.jpg">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img" src="/adminlte/dist/img/user7-128x128.jpg">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img" src="/adminlte/dist/img/user3-128x128.jpg">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img" src="/adminlte/dist/img/user5-128x128.jpg">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img" src="/adminlte/dist/img/user6-128x128.jpg">
											...
											<!-- End Contact Item -->
											<li><a href="#"> <img class="contacts-list-img" src="/adminlte/dist/img/user8-128x128.jpg">
						...
						<section class="col-lg-5 connectedSortable">
							...
							<div class="card bg-gradient-info">
								...
								<div class="card-body">
									<canvas class="chart" id="line-chart" style="min-height: 250px; height: 250px; max-height: 250px;"></canvas>
								</div>
								<!-- /.card-body -->
								<div class="card-footer bg-transparent">
									<div class="row">
